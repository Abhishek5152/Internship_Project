                                ...
                                updateElement: function (t, e, i) {
                                    ...
                                    (void 0 !== u.radius && void 0 === u.pointRadius && (u.pointRadius = u.radius),
                                        ...
                                        (t._model = {
                                            ...
                                            hitRadius:
                                                l.hitRadius ||
                                                o.valueAtIndexOrDefault(u.pointHitRadius, e, g.hitRadius),
                                        }));
                                },
            ...
            32: [
                function (t, e, i) {
                    ...
                    function l(t, e, i) {
                        ...
                        return (
                            i && (n -= 0 === e ? (t.getPixelForTick(1) - n) / 2 : (n - t.getPixelForTick(e - 1)) / 2),
                            n
                        );
                    }
                    (n._set('scale', {
                            ...
                            t.Scale = a.extend({
                                ...
                                update: function (t, e, i) {
                                    ...
                                    for (
                                        ...
                                        ((s = r[n]),
                                            (u = l[n]) ? (u.label = s) : l.push((u = { label: s, major: !1 })));
                                    return (
                                        (d._ticks = l),
                                            ...
                                            (A = (function (t, e) {
                                                ...
                                                ('center' === c
                                                    ...
                                                    i(s.x)
                                                        ...
                                                        : n(s.x) &&
                                                          ((d = 'right'), o(s.x) && ((d = 'center'), (c = r(s.y)))));
                                                var g = t._options;
                                                return {
